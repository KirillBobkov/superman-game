...
export const resetGameButton = document.getElementById('resetGame');
export const restartGameButton = document.getElementById('restartGame');
export const pauseGameButton = document.getElementById('pauseGame');
export const resumeGameButton = document.getElementById('resumeGame');
